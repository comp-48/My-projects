...
class VideoRecorderApp:
    def __init__(self, root):
        ...
        self.current_video_path = None   # для аудио
    ...
    def stop_audio_recording(self, video_path):
        ...
        try:
            ...
            self.file_info_label.config(text=f"Файл с аудио: {os.path.basename(video_path)}")
    ...
    def open_settings(self):
        ...
        # Опция записи звука
        tk.Label(settings_win, text="Записывать звук:").pack(pady=5)
        audio_var = tk.BooleanVar(value=self.audio_enabled)
        tk.Checkbutton(settings_win, text="Включить запись звука", variable=audio_var).pack(pady=5)
        ...
        def import_settings():
            ...
            try:
                ...
                if "audio_enabled" in data:
                    ...
                    audio_var.set(self.audio_enabled)
